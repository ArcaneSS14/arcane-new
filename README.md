...
**Arcane Station** — это форк [Trauma Station](https://github.com/Trauma-Station/Trauma-Station), в свою очередь являющийся форком [WizDen](https://github.com/space-wizards/space-station-14) и [Goob Station](https://github.com/Goob-Station/Goob-Station), который стремится возродить дух классического геймплея Space Station 13, черпая вдохновение из таких проектов, как [/tg/station](https://github.com/tgstation/tgstation) и [Shiptest](https://github.com/shiptest-ss13/Shiptest).

Ранее проект являлся форком русскоязычного репозитория [Orion-Station-14](https://github.com/AtaraxiaSpaceFoundation/Orion-Station-14), в свою очередь являющийся форком [Goob Station](https://github.com/Goob-Station/Goob-Station).
...
Мы всегда рады помощи в разработке, если вы хотите внести свой вклад, присоединяйтесь к [серверу разработки в Discord](https://discord.gg/T7QnvQ5W7z). Вы можете помочь нам, решая проблемы из [списка открытых проблем](https://github.com/ArcaneSS14/arcane-new/issues) или предлагая свои идеи. Не стесняйтесь задавать вопросы — мы всегда готовы помочь!
